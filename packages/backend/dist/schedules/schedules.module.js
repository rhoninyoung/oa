...
const schedules_controller_js_1 = require("./schedules.controller.js");
...
exports.SchedulesModule = SchedulesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [schedules_controller_js_1.SchedulesController],
        providers: [schedules_service_js_1.SchedulesService, prisma_service_js_1.PrismaService],
        exports: [schedules_service_js_1.SchedulesService],
    })
], SchedulesModule);
