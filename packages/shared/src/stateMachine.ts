...
import type { ScheduleStatus, Role, Action, Task } from './types.js';
...
/**
 * @param from - Current schedule status
 * @param action - Action to perform
 * @param actor - Role of the user performing the action
 * @param ctx - Context including tasks and reason
 ...
 * @param from - Current schedule status
 * @param action - Action to perform
 * @returns Next status or null if transition is invalid
 */
export function nextStatus(from: ScheduleStatus, action: Action): ScheduleStatus | null {
